...
interface StrFinderButtonPopUpProps {
  textContent?: any;
  btnHeight?: string;
  btnWidth?: string;
  btnMargin?: string;
...
const StrFinderButtonPopUp: FC<StrFinderButtonPopUpProps> = (props) => {
  ...
  const btnWidthLocal = btnWidth ?? "80vw";
...
export default StrFinderButtonPopUp;
